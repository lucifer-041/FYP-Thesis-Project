...
namespace HealthHub
{
    public partial class Allergist : Page
    {
        ...
        private void LoadAllergists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetAllergists", conn);
            ...
            rptAllergists.DataSource = doctors;
            rptAllergists.DataBind();
        }

        protected void rptAllergists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Allergist/Immunologist";
