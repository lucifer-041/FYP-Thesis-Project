...
namespace HealthHub
{
    public partial class Hematologist : Page
    {
        ...
        private void LoadHematologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetHematologists", conn);
            ...
            rptHematologists.DataSource = doctors;
            rptHematologists.DataBind();
        }

        protected void rptHematologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Hematologist";
