...
namespace HealthHub
{
    public partial class Geriatrician : Page
    {
        ...
        private void LoadGeriatricians()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetGeriatricians", conn);
            ...
            rptGeriatricians.DataSource = doctors;
            rptGeriatricians.DataBind();
        }

        protected void rptGeriatricians_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Geriatrician";
