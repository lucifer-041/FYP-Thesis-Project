<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hepatologist.aspx.cs" Inherits="HealthHub.Hepatologist" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Hepatologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptHepatologists" runat="server" OnItemDataBound="rptHepatologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
