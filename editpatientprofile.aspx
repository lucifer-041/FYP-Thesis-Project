<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPatientProfile.aspx.cs" Inherits="HealthHub.EditPatientProfile" %>
...
<body>
    ...
    <div class="container">
        ...
        <form id="editProfileForm" runat="server" class="profile-form">
            ...
            <asp:LinkButton ID="btnDashboard" runat="server" CssClass="dashboard-button" PostBackUrl="patientdashboard.aspx">Go to Patient Dashboard</asp:LinkButton>
        </form>
    </div>
    <footer>
