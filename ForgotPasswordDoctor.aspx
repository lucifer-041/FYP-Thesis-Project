<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPasswordDoctor.aspx.cs" Inherits="HealthHub.ForgotPasswordDoctor" %>
    ...
    <div class="container">
        ...
        <div class="right-section">
            <form class="login-form" runat="server">
                ...
                <p class="signup-link">Remember your password? <a href="doctorlogin.aspx">Log In</a></p>
            </form>
        </div>
    </div>
    <footer>
