<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Neurologist.aspx.cs" Inherits="HealthHub.Neurologist" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Neurologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptNeurologists" runat="server" OnItemDataBound="rptNeurologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
