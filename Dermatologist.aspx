<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dermatologist.aspx.cs" Inherits="HealthHub.Dermatologist" %>
...
<head>
    ...
    <title>Dermatologist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Dermatologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />

        </div>

        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptDermatologists" runat="server" OnItemDataBound="rptDermatologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
