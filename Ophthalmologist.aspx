<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ophthalmologist.aspx.cs" Inherits="HealthHub.Ophthalmologist" %>
...
<head>
    ...
    <title>Ophthalmologist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Ophthalmologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptOphthalmologists" runat="server" OnItemDataBound="rptOphthalmologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
