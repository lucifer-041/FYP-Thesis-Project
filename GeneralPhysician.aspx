<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralPhysician.aspx.cs" Inherits="HealthHub.GeneralPhysician" %>
...
<head>
    ...
    <title>General Physician List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find General Physicians Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptGeneralPhysicians" runat="server" OnItemDataBound="rptGeneralPhysicians_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
