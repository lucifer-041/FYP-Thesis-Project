<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doctorlogin.aspx.cs" Inherits="Healthhub.Login" %>
...
<body>
    ...
    <div class="container">
        <div class="left-section">
            <h1 style="text-align: center">Welcome Back to the Learning Experience.</h1>
        ...
        <div class="right-section">
            <form class="login-form" runat="server">
                ...
                <br />
                <br />
                <p><a href="ForgotPasswordDoctor.aspx">Forgot Password?</a></p>
