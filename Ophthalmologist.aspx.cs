...
namespace HealthHub
{
    public partial class Ophthalmologist : Page
    {
        ...
        private void LoadOphthalmologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetOphthalmologists", conn);
            ...
            rptOphthalmologists.DataSource = doctors;
            rptOphthalmologists.DataBind();
        }

        protected void rptOphthalmologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
