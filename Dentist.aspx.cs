...
namespace HealthHub
{
    public partial class Dentist : Page
    {
        ...
        private void LoadDentists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetDentists", conn);
            ...
            rptDentists.DataSource = doctors;
            rptDentists.DataBind();
        }

        protected void rptDentists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
