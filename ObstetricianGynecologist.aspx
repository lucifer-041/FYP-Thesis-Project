<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ObstetricianGynecologist.aspx.cs" Inherits="HealthHub.ObstetricianGynecologist" %>
...
<head>
    ...
    <title>Obstetrician and Gynecologist (OB-GYN) List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find OB-GYNs Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptObstetricianGynecologists" runat="server" OnItemDataBound="rptObstetricianGynecologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
