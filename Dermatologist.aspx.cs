...
namespace HealthHub
{
    public partial class Dermatologist : Page
    {
        ...
        private void LoadDermatologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetDermatologists", conn);
 ...
 { "ProfileImage", firstRow["ProfileImage"] != DBNull.Value ? firstRow["ProfileImage"].ToString() : "neutraldoctor.jpg" }                };
            ...
            rptDermatologists.DataSource = doctors;
            rptDermatologists.DataBind();
        }

        protected void rptDermatologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
