...
namespace HealthHub
{
    public partial class Pathologist : Page
    {
        ...
        private void LoadPathologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetPathologists", conn);
            ...
            rptPathologists.DataSource = doctors;
            rptPathologists.DataBind();
        }

        protected void rptPathologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
