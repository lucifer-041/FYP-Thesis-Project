<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hematologist.aspx.cs" Inherits="HealthHub.Hematologist" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Hematologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptHematologists" runat="server" OnItemDataBound="rptHematologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
