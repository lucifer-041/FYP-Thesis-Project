...
namespace HealthHub
{
    public partial class Gastroenterologist : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LoadGastroenterologists();
            }
        }

        private void LoadGastroenterologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetGastroenterologists", conn);
            ...
            rptGastroenterologists.DataSource = doctors;
            rptGastroenterologists.DataBind();
        }

        protected void rptGastroenterologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Gastroenterologist";
