<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FamilyMedicine.aspx.cs" Inherits="HealthHub.FamilyMedicine" %>
...
<head>
    ...
    <title>Family Medicine Physician List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Family Medicine Physicians Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptFamilyMedicine" runat="server" OnItemDataBound="rptFamilyMedicine_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
