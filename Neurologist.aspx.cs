...
namespace HealthHub
{
    public partial class Neurologist : Page
    {
        ...
        private void LoadNeurologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetNeurologists", conn);
            ...
            rptNeurologists.DataSource = doctors;
            rptNeurologists.DataBind();
        }

        protected void rptNeurologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
