<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Urologist.aspx.cs" Inherits="HealthHub.Urologist" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Urologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptUrologists" runat="server" OnItemDataBound="rptUrologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
