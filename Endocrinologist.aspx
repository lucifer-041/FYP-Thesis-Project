<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Endocrinologist.aspx.cs" Inherits="HealthHub.Endocrinologist" %>
...
<head>
    ...
    <title>Endocrinologist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Endocrinologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptEndocrinologists" runat="server" OnItemDataBound="rptEndocrinologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
