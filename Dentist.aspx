<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dentist.aspx.cs" Inherits="HealthHub.Dentist" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Dentists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptDentists" runat="server" OnItemDataBound="rptDentists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
