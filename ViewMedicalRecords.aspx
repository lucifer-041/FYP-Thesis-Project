<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewMedicalRecords.aspx.cs" Inherits="Healthhub.ViewMedicalRecords" %>
...
<body>
    ...
    <div class="container">
        <h1>Medical Records for <asp:Label ID="lblPatientName" runat="server" CssClass="patient-name" /></h1>
