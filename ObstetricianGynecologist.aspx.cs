...
namespace HealthHub
{
    public partial class ObstetricianGynecologist : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LoadObstetricianGynecologists();
            }
        }

        private void LoadObstetricianGynecologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetObstetricianGynecologists", conn);
            ...
            rptObstetricianGynecologists.DataSource = doctors;
            rptObstetricianGynecologists.DataBind();
        }

        protected void rptObstetricianGynecologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Obstetrician and Gynecologist (OB-GYN)";
