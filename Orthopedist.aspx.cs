...
namespace HealthHub
{
    public partial class Orthopedist : Page
    {
        ...
        private void LoadOrthopedists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetOrthopedists", conn);
            ...
            rptOrthopedists.DataSource = doctors;
            rptOrthopedists.DataBind();
        }

        protected void rptOrthopedists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Orthopedist/Orthopedic Surgeon";
