...
namespace HealthHub
{
    public partial class Hepatologist : Page
    {
        ...
        private void LoadHepatologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetHepatologists", conn);
            ...
            rptHepatologists.DataSource = doctors;
            rptHepatologists.DataBind();
        }

        protected void rptHepatologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Hepatologist";
