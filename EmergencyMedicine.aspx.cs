...
namespace HealthHub
{
    public partial class EmergencyMedicine : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LoadEmergencyMedicineSpecialists();
            }
        }

        private void LoadEmergencyMedicineSpecialists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetEmergencyMedicineSpecialists", conn);
            ...
            rptEmergencyMedicine.DataSource = doctors;
            rptEmergencyMedicine.DataBind();
        }

        protected void rptEmergencyMedicine_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Emergency Medicine Specialist";
