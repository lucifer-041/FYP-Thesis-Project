...
namespace HealthHub
{
    public partial class GeneralPhysician : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LoadGeneralPhysicians();
            }
        }

        private void LoadGeneralPhysicians()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetGeneralPhysicians", conn);
            ...
            rptGeneralPhysicians.DataSource = doctors;
            rptGeneralPhysicians.DataBind();
        }

        protected void rptGeneralPhysicians_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
