<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rheumatologist.aspx.cs" Inherits="HealthHub.Rheumatologist" %>
...
<head>
    ...
    <title>Rheumatologist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Rheumatologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptRheumatologists" runat="server" OnItemDataBound="rptRheumatologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
