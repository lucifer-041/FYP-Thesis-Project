<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmergencyMedicine.aspx.cs" Inherits="HealthHub.EmergencyMedicine" %>
...
<head>
    ...
    <title>Emergency Medicine Specialist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Emergency Medicine Specialists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptEmergencyMedicine" runat="server" OnItemDataBound="rptEmergencyMedicine_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
