...
namespace HealthHub
{
    public partial class Anesthesiologist : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LoadAnesthesiologists();
            }
        }

        private void LoadAnesthesiologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetAnesthesiologists", conn);
            ...
            rptAnesthesiologists.DataSource = doctors;
            rptAnesthesiologists.DataBind();
        }

        protected void rptAnesthesiologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
