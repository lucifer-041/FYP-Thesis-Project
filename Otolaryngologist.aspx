<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Otolaryngologist.aspx.cs" Inherits="HealthHub.Otolaryngologist" %>
...
<head>
    ...
    <title>Otolaryngologist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Otolaryngologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptOtolaryngologists" runat="server" OnItemDataBound="rptOtolaryngologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
