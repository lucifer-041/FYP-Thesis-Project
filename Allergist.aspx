<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Allergist.aspx.cs" Inherits="HealthHub.Allergist" %>
...
<head>
    ...
    <title>Allergist/Immunologist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <strong>
                <asp:Button ID="btnFilter" runat="server" Text="Apply Filter" OnClick="btnFilter_Click" /></strong>
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Allergists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptAllergists" runat="server" OnItemDataBound="rptAllergists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
