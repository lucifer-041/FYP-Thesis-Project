<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Psychiatrist.aspx.cs" Inherits="HealthHub.Psychiatrist" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Psychiatrists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptPsychiatrists" runat="server" OnItemDataBound="rptPsychiatrists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
