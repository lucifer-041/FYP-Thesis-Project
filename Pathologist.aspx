<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pathologist.aspx.cs" Inherits="HealthHub.Pathologist" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Pathologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptPathologists" runat="server" OnItemDataBound="rptPathologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
