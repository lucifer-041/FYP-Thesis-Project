...
namespace HealthHub
{
    public partial class Internist : Page
    {
        ...
        private void LoadInternists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetInternists", conn);
            ...
            rptInternists.DataSource = doctors;
            rptInternists.DataBind();
        }

        protected void rptInternists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Internist";
