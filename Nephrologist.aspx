<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nephrologist.aspx.cs" Inherits="HealthHub.Nephrologist" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Nephrologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptNephrologists" runat="server" OnItemDataBound="rptNephrologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
