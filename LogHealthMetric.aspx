<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogHealthMetric.aspx.cs" Inherits="Healthhub.LogHealthMetric" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Log Health Metrics</title>
...
<body>
    ...
    <form id="Form1" runat="server" class="container">
        <h1 class="text-2xl font-bold mb-6">Log Health Metrics</h1>

        <div class="section mb-4">

            <label for="glucoseValueTextBox">Blood Glucose Value:</label>
            <asp:TextBox ID="glucoseValueTextBox" runat="server" CssClass="mt-1"></asp:TextBox>
            <button type="button" onclick="document.getElementById('<%= logGlucoseBtn.ClientID %>').click();">Log Blood Glucose</button>
            <asp:Button ID="logGlucoseBtn" Text="Log Blood Glucose" OnClick="LogGlucoseBtn_Click" runat="server" Style="display: none;" />
        </div>

        <div class="section mb-4">

            <label for="pressureValueTextBox">Blood Pressure Value:</label>
            <asp:TextBox ID="pressureValueTextBox" runat="server" CssClass="mt-1"></asp:TextBox>
            <button type="button" onclick="document.getElementById('<%= logPressureBtn.ClientID %>').click();">Log Blood Pressure</button>
            <asp:Button ID="logPressureBtn" Text="Log Blood Pressure" OnClick="LogPressureBtn_Click" runat="server" Style="display: none;" />
        </div>

        <div class="section mb-4">
            <label for="cholesterolValueTextBox">Cholesterol Value:</label>
            <asp:TextBox ID="cholesterolValueTextBox" runat="server" CssClass="mt-1"></asp:TextBox>
            <button type="button" onclick="document.getElementById('<%= logCholesterolBtn.ClientID %>').click();">Log Cholesterol</button>
            <asp:Button ID="logCholesterolBtn" Text="Log Cholesterol" OnClick="LogCholesterolBtn_Click" runat="server" Style="display: none;" />
        </div>
    </form>
    <footer>
