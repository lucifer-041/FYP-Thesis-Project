<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPasswordPatient.aspx.cs" Inherits="HealthHub.ResetPasswordPatient" %>
        ...
        <div class="right-section">
            <form class="login-form" runat="server">
                ...
                <div class="input-field">
                    ...
                    <asp:TextBox ID="txtNewPassword" runat="server" CssClass="input-field password-field" TextMode="Password" ClientIDMode="Static" />
                    <div id="passwordError" class="error-message">Password must be at least 8 characters long, contain at least one uppercase letter and one number.</div>
                </div>
                <div class="input-field">
                    <label for="confirm-password">Confirm Password</label>
                    <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="input-field password-field" TextMode="Password" ClientIDMode="Static" />
                    <div id="confirmPasswordError" class="error-message">Passwords do not match.</div>
                </div>
                <asp:Label ID="lblMessage" runat="server" CssClass="error-message" />
                <asp:Button ID="btnSubmit" runat="server" CssClass="button" Text="Submit" OnClick="btnSubmit_Click" ClientIDMode="Static" />
                <p class="signup-link">Remember your password? <a href="patientlogin.aspx">Log In</a></p>
            </form>
        </div>
    </div>
   <footer>
    ...
    <script>
        ...
        document.getElementById('<%= txtNewPassword.ClientID %>').addEventListener('input', validatePassword);
        document.getElementById('<%= txtConfirmPassword.ClientID %>').addEventListener('input', validateConfirmPassword);
