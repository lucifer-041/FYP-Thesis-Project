<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecommendedDoctorsList.aspx.cs" Inherits="HealthHub.RecommendedDoctorsList" Async="true" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Recommended Doctors List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="header">
            <h1>Doctor Recommendations Based on Your Symptoms</h1>
        </div>
