<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPasswordPatient.aspx.cs" Inherits="HealthHub.ForgotPasswordPatient" %>
        ...
        <div class="right-section">
            <form class="login-form" runat="server">
                ...
                <div class="input-field">
                    ...
                    <asp:TextBox ID="txtEmail" runat="server" CssClass="input-field" TextMode="Email" ClientIDMode="Static" AutoPostBack="true" OnTextChanged="txtEmail_TextChanged" />
                </div>
                <div class="input-field">
                    <label for="security-question">Security Question</label>
                    <asp:Label ID="lblSecurityQuestion" runat="server" CssClass="input-field" Text="" />
                </div>
                <div class="input-field">
                    <label for="security-answer">Answer</label>
                    <asp:TextBox ID="txtSecurityAnswer" runat="server" CssClass="input-field" ClientIDMode="Static" />
                </div>
