...
namespace HealthHub
{
    public partial class Nephrologist : Page
    {
        ...
        private void LoadNephrologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetNephrologists", conn);
            ...
            rptNephrologists.DataSource = doctors;
            rptNephrologists.DataBind();
        }

        protected void rptNephrologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
