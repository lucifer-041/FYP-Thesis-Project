<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SportsMed.aspx.cs" Inherits="HealthHub.SportsMed" %>
...
<head>
    ...
    <title>Sports Medicine Specialist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Sports Medicine Specialists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptSportsMed" runat="server" OnItemDataBound="rptSportsMed_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
