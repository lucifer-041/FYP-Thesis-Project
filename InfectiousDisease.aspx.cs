...
namespace HealthHub
{
    public partial class InfectiousDisease : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LoadInfectiousDiseaseSpecialists();
            }
        }

        private void LoadInfectiousDiseaseSpecialists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetInfectiousDiseaseSpecialists", conn);
            ...
            rptInfectiousDisease.DataSource = doctors;
            rptInfectiousDisease.DataBind();
        }

        protected void rptInfectiousDisease_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Infectious Disease Specialist";
