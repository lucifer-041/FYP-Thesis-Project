...
namespace HealthHub
{
    public partial class Oncologist : Page
    {
        ...
        private void LoadOncologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetOncologists", conn);
            ...
            rptOncologists.DataSource = doctors;
            rptOncologists.DataBind();
        }

        protected void rptOncologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
