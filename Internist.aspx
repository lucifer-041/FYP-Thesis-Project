<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Internist.aspx.cs" Inherits="HealthHub.Internist" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Internists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptInternists" runat="server" OnItemDataBound="rptInternists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
