...
namespace HealthHub
{
    public partial class Cardiologist : Page
    {
        ...
        private void LoadCardiologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetCardiologists", conn);
            ...
            rptCardiologists.DataSource = doctors;
            rptCardiologists.DataBind();
        }

        protected void rptCardiologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
