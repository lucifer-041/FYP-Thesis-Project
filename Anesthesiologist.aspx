<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Anesthesiologist.aspx.cs" Inherits="HealthHub.Anesthesiologist" %>
...
<head>
    ...
    <title>Anesthesiologist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Anesthesiologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptAnesthesiologists" runat="server" OnItemDataBound="rptAnesthesiologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
