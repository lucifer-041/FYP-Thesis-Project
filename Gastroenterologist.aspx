<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gastroenterologist.aspx.cs" Inherits="HealthHub.Gastroenterologist" %>
...
<head>
    ...
    <title>Gastroenterologist List</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="filter-section">
            ...
            <asp:Button ID="btnFindNearby" runat="server" Text="Find Gastroenterologists Near Me" CssClass="btn-find-near-me" OnClick="btnFindNearby_Click" />
        </div>
        <div id="doctorList" runat="server"></div>
        <div class="container" runat="server">
            <asp:Repeater ID="rptGastroenterologists" runat="server" OnItemDataBound="rptGastroenterologists_ItemDataBound">
                <ItemTemplate>
                    <div class="card">
