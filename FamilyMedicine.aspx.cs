...
namespace HealthHub
{
    public partial class FamilyMedicine : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LoadFamilyMedicinePhysicians();
            }
        }

        private void LoadFamilyMedicinePhysicians()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetFamilyMedicinePhysicians", conn);
            ...
            rptFamilyMedicine.DataSource = doctors;
            rptFamilyMedicine.DataBind();
        }

        protected void rptFamilyMedicine_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Family Medicine Physician";
