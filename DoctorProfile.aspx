<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorProfile.aspx.cs" Inherits="HealthHub.DoctorProfile" %>
...
@media screen and (max-width: 600px) {
    ...
    .benefit-item {
        ...
        .feedback-box::before {
            ...
            bottom: 0;
            width: 5px;
            background-color: #004e70; /* Change to your desired blue color */
    ...
    <div class="main-container">
        <div class="profile-container">
            <div class="profile-header">
                <asp:Image ID="imgDoctor" runat="server" alt="Doctor Image" />
                <div>
                    <h2><asp:Label ID="lblFullName" runat="server" /></h2>
                    <p><asp:Label ID="lblSpecialization" runat="server" /></p>
                    <p>Experience: <asp:Label ID="lblYearsOfExperience" runat="server" /> Years</p>
                    <p>Satisfied Patients: <asp:Label ID="lblSatisfiedPatients" runat="server" /></p>
            ...
            <div class="info-section">
                <div class="info-box">
                    <h3>About Dr. <asp:Label ID="lblFullNameAbout" runat="server" /></h3>
                    <p><asp:Label ID="lblBioDetail" runat="server" /></p>
                </div>
            </div>
            <div class="info-box">
                <h3>Education</h3>
                <p><asp:Label ID="lblEducation" runat="server" /></p>
            </div>
            <div class="info-box">
                <h3>Specializations</h3>
                <p><asp:Label ID="lblSpecializations" runat="server" /></p>
            </div>
            <div class="info-box">
                <h3>Feedback from Patients (<asp:Label ID="lblReviewCount" runat="server" />)</h3>
                <asp:Repeater ID="rptReviews" runat="server">
                    <ItemTemplate>
                        <div class="feedback-box">
                            <p class="recommendation"><strong><%# Eval("Recommend") %></strong></p>
                            <div class="star-rating">
                                <%# GetStarRating(Convert.ToInt32(Eval("Rating"))) %>
                            </div>
                            <p><%# Eval("ReviewText") %></p>
                            <p class="verified-patient">Verified Patient • <%# Eval("ReviewDate", "{0:MM/dd/yyyy}") %></p>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
            ...
            <asp:Repeater ID="rptHospitals" runat="server">
                <ItemTemplate>
                    <div class="consultation-box">
                        <h4>Hospital:<strong> <%# Eval("HospitalName") %> </strong></h4>
                        <p><strong>Fees: </strong> <%# "Rs." + Eval("Fees") %></p>
                        <br />
                        <h4>Availability</h4>
                        <asp:Repeater ID="rptAvailability" runat="server" DataSource='<%# Eval("Availability") %>'>
                            <ItemTemplate>
                                <p><%# Eval("AvailableDay") %>: <%# Eval("StartTime") %> - <%# Eval("EndTime") %></p>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
                </ItemTemplate>
