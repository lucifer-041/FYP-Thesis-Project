...
namespace HealthHub
{
    public partial class Otolaryngologist : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LoadOtolaryngologists();
            }
        }

        private void LoadOtolaryngologists()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetOtolaryngologists", conn);
            ...
            rptOtolaryngologists.DataSource = doctors;
            rptOtolaryngologists.DataBind();
        }

        protected void rptOtolaryngologists_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        {
            string specialization = "Otolaryngologist (ENT specialist)";
